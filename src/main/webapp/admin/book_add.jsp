...
<div id="header"></div>
 ...
 <div class="container col-sm-7 col-sm-offset-3">
   <h2 class="page-header text-success">图书添加</h2>
        <form class="col-sm-8 col-sm-offset-1" style="margin-top:30px" action="/admin/book_add_do.html" method="post" id="addbook">
        ...
        <table class="table">
	        <tr>
	         ...
	         <tr>
	           <td>出版社</td>
	           <td><input name="publish" id="publish"></td>
	        </tr>
	         <tr>
	           <td>ISBN</td>
	         ...
	         <tr>
	           <td>简介</td>
	           <td> 
	           <textarea rows="4" cols="30"  name="introduction" id="introduction"></textarea>
	           </td>
	        </tr>
	        <tr>
	           <td>数量</td>
